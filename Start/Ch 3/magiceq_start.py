...
print(b1==b3) # returns false if __eq__ is not defined, because python doesn't compare objects by value by default
print(b1==b2)
print(b1==42)
...
books = [b1,b3,b2,b4]
books.sort() # built in sort function sorts based on __lt__ method 
